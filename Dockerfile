...
# docker tag swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/nginx:1.28.0-alpine3.21 docker.io/nginx:alpine

# docker pull swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/node:22-alpine3.22
# docker tag swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/node:22-alpine3.22 docker.io/node:22-alpine
